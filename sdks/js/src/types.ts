...
export type CanaryGateOptions = {
  ...
  /** Called whenever the evaluated flag set changes (polling refresh or SSE event). Receives the updated evaluated flags. Never called on initial load. */
  onUpdate?: (flags: FlagData[]) => void
}
