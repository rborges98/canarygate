...
description: Schedule automatic activations and rollouts at defined times (Pro plan).
keywords:
...
<Callout type="warning">
  Schedule and auto-rollout are **Pro plan** features. On the Starter plan,
  rollout is always manual.
</Callout>
