...
During the beta phase, history is retained for 90 days. Future plans may adjust this period.

## Export

You can export the full history as CSV via **Settings → Audit Log → Export**.
