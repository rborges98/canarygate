...
export default async function DevelopmentFlagsPage({
  params,
  searchParams
}: Props) {
  ...
  const {
    ...
    page: currentPage,
    pageSize
  } = await getFlags(org.id, project.id, 'development', page)
  ...
  return (
    <FlagsList
      ...
      pagination={{
        ...
        pageSize,
        total,
        baseHref: `/orgs/${orgSlug}/projects/${projectSlug}/flags/development`
      }}
    />
  )
}